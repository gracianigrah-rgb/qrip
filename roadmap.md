...
- [x] Afficher le nom de l’entreprise sur la carte du solde.
- [x] Afficher le nom dans le rapport visible et partagé.
- [x] Inclure le nom dans les exports CSV et PDF.
- [x] Vérifier l’affichage mobile et les exports.
- [x] Ajouter le logo qrip et la mascotte comme identité de l’application.
- [x] Demander le logo, le téléphone, la ville, le pays et le quartier de l’entreprise.
